...
def test_get_length_validator(value_source_resolver, rule_evaluator):
    string_handler = StringHandler({}, value_source_resolver, rule_evaluator, error_messages)
...
def test_get_length_validator_with_message_override(value_source_resolver, rule_evaluator):
    ...
    string_handler = StringHandler(answer, value_source_resolver, rule_evaluator, error_messages)
