...
def test_month_year_date_field_created_with_guidance(value_source_resolver, rule_evaluator):
    date_json = {
        "guidance": "",
    ...
    handler = MonthYearDateHandler(date_json, value_source_resolver, rule_evaluator, error_messages)
