...
def test_get_field(answer_options, expected_choices, value_source_resolver, rule_evaluator):
    radio_json = {
        "guidance": "",
    ...
    handler = SelectHandler(radio_json, value_source_resolver, rule_evaluator, error_messages)
...
def test_build_choices_no_dynamic_or_static_options(value_source_resolver, rule_evaluator):
