...
def test_build_choices_without_placeholder(answer_options, choices, value_source_resolver, rule_evaluator):
    dropdown_answer_schema = get_dropdown_answer_schema(answer_options)
    handler = DropdownHandler(dropdown_answer_schema, value_source_resolver, rule_evaluator, error_messages)
...
def test_build_choices_with_placeholder(answer_options, choices, value_source_resolver, rule_evaluator):
    dropdown_answer_schema = get_dropdown_answer_schema(answer_options)
...
def test_build_choices_no_dynamic_or_static_choices(value_source_resolver, rule_evaluator):
