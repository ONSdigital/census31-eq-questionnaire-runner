...
def test_started_at_should_be_set_in_payload_if_present_in_response_metadata(fake_questionnaire_schema, fake_questionnaire_store):
    answer_object = convert_answers(fake_questionnaire_schema, fake_questionnaire_store, {})

    assert answer_object["started_at"] == fake_questionnaire_store.response_metadata["started_at"]
...
def test_display_address_should_be_set_in_payload_metadata(fake_questionnaire_schema, fake_questionnaire_store):

    payload = convert_answers(fake_questionnaire_schema, fake_questionnaire_store, {})

    assert payload["metadata"]["display_address"], fake_questionnaire_store.metadata["display_address"]
