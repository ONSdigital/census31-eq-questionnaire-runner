...
def test_deserialize_does_not_default_to_iso_format():
    ...
    assert (
        date_string._deserialize(value="2014-12-22", attr="", data="")  # pylint: disable=protected-access
        == "2014-12-22"
    )
...
def test_deserialize_incorrect_format_errors_with_default_format():
    ...
    with pytest.raises(Exception) as e:
        date_string._deserialize(value="2014-12-32", attr="", data="")  # pylint: disable=protected-access
