...
def test_custom_format_unit(value, measurement_unit, locale_string, length, expected_result):
...
def test_custom_format_currency(value, currency, locale_string, decimal_limit, expected_result):
