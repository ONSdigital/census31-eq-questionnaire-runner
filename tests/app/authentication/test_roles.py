...
def test_role_required_unauthenticated_no_metadata(mock_get_metadata, mock_current_user):
...
def test_role_required_authenticated_with_empty_metadata(mock_get_metadata, mock_current_user):
...
def test_role_required_authenticated_with_metadata_none_roles(mock_get_metadata, mock_current_user):
...
def test_role_required_authenticated_with_metadata_empty_roles(mock_get_metadata, mock_current_user):
...
def test_role_required_authenticated_with_metadata_wrong_role(mock_get_metadata, mock_current_user):
...
def test_role_required_authenticated_with_metadata_matching_role(mock_get_metadata, mock_current_user):
    # Given I am authenticated and my metadata contains a single role.
    mock_current_user.is_authenticated = True
...
def test_role_required_authenticated_with_metadata_matching_multiple_role(mock_get_metadata, mock_current_user):
    # Given I am authenticated but my metadata contains multiples roles
    mock_current_user.is_authenticated = True
    mock_get_metadata.return_value = get_metadata(extra_metadata={"roles": ["flusher", "other", "dumper"]})
...
def test_role_required_wrapped_with_positional_arguments(mock_get_metadata, mock_current_user):
...
def test_role_required_wrapped_with_keyword_arguments(mock_get_metadata, mock_current_user):
    # Given I am authenticated and my metadata contains roles
    mock_current_user.is_authenticated = True
    mock_get_metadata.return_value = get_metadata(extra_metadata={"roles": ["flusher", "other", "dumper"]})
...
def test_role_required_wrapped_with_positional_and_keyword_arguments(mock_get_metadata, mock_current_user):
    # Given I am authenticated and my metadata contains roles
    mock_current_user.is_authenticated = True
    mock_get_metadata.return_value = get_metadata(extra_metadata={"roles": ["flusher", "other", "dumper"]})
...
def test_role_required_unauthenticated_wrapped_with_arguments(mock_get_metadata, mock_current_user):
...
def test_role_required_unauthenticated_wrapped_with_keyword_arguments(mock_get_metadata, mock_current_user):
    # Given I am not authenticated
    mock_current_user.is_authenticated = False
    mock_get_metadata.return_value = get_metadata(extra_metadata={"roles": ["flusher", "other", "dumper"]})
