...
class TestQuestionnaireListChangeEvaluatesSections(QuestionnaireTestCase):
    ...
    def test_without_primary_person(self):
        self.launchSurvey(schema_name="test_list_change_evaluates_sections")
        ...
        self.assertInSelector("Partially completed", "[data-qa='hub-row-accommodation-section-state']")
    ...
    def test_with_primary_person(self):
        ...
        self.assertInSelector("Completed", "[data-qa='hub-row-accommodation-section-state']")
