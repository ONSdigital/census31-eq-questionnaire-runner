...
class TestSchemaThemeThankYou(IntegrationTestCase):
    def test_census_individual(self):
        ...
        self.assertInBody("Your individual census has been submitted for <strong>68 Abingdon Road, Goathill</strong>")
    ...
    def test_census_household(self):
        ...
        self.assertInBody("Your census has been submitted for the household at <strong>68 Abingdon Road, Goathill</strong>")
    ...
    def test_census_communal_establishment(self):
        ...
        self.post()
        self.assertInBody("Thank you for completing the census")
        self.assertInBody("Your census has been submitted for the accommodation at <strong>68 Abingdon Road, Goathill</strong>")
