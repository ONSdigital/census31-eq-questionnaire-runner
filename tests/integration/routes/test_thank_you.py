...
class TestThankYou(IntegrationTestCase):
    def test_thank_you_page_no_sign_out(self):
        self.launchSurvey(schema_name="test_currency")
    ...
    def test_can_switch_language_on_thank_you_page(self):
        self.launchSurvey(schema_name="test_language")
        self.post()
        # We fill in our answers
    ...
    def test_back_to_surveys_link_not_on_thank_you_theme_census(self):
    ...
    def test_view_answers_after_submission_guidance(self):
        ...
        self.assertInUrl("thank-you")
        self.assertInBody("For security, your answers will only be available to view for 45 minutes")
