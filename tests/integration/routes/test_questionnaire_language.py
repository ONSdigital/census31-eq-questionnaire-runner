...
class TestQuestionnaireLanguage(IntegrationTestCase):
    ...
    def test_load_cy_survey(self):
        ...
        self.launchSurvey(schema_name="test_language", language_code="cy")
    ...
    def test_load_non_existent_lang_fallback(self):
        ...
        self.launchSurvey(schema_name="test_language", language_code="hi")
    ...
    def test_language_switch_in_flight(self):
        ...
        self.launchSurvey(schema_name="test_language", language_code="en")
