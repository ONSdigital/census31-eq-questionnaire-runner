...
import CalculatedSummaryValueSalesPage from "../../generated_pages/supplementary_data_repeating_block_and_calculated_summary/" +
  "calculated-summary-value-sales.page.js";
import CalculatedSummaryVolumeSalesPage from "../../generated_pages/supplementary_data_repeating_block_and_calculated_summary/" +
  "calculated-summary-volume-sales.page.js";
import CalculatedSummaryVolumeTotalPage from "../../generated_pages/supplementary_data_repeating_block_and_calculated_summary/" +
  "calculated-summary-volume-total.page.js";
...
import ProductRepeatingBlock1Page from "../../generated_pages/supplementary_data_repeating_block_and_calculated_summary/" +
  "product-repeating-block-1-repeating-block.page.js";
...
describe("Using supplementary data", () => {
  ...
  it(
    "Given I have some repeating blocks with supplementary data, " +
      "When I begin the section, Then I see the supplementary names rendered correctly",
    async () => {
  ...
  it(
    "Given I have repeating blocks with supplementary data, " +
      "When I start the first repeating block, Then I see the supplementary data for the first list item",
    async () => {
  ...
  it(
    "Given I have repeating blocks with supplementary data, " +
      "When I start the second repeating block, Then I see the supplementary data for the second list item",
    async () => {
  ...
  it(
    "Given I have a calculated summary using the repeating blocks, " +
      "When I reach the Calculated Summary, Then I see the correct total and supplementary data labels",
    async () => {
    await click(ListCollectorProductsPage.submit());
  ...
  it(
    "Given I have another calculated summary using the repeating blocks, " +
      "When I reach the Calculated Summary, Then I see the correct total and supplementary data labels",
    async () => {
  ...
  it(
    "Given I have dynamic answers using a supplementary list, " +
      "When I reach the dynamic answer page, Then I see the correct supplementary data in the answer labels",
    async () => {
  ...
  it(
    "Given I have a calculated summary of dynamic answers for a supplementary list, " +
      "When I reach the calculated summary, Then I see the correct supplementary data in the title and labels",
    async () => {
  ...
  it(
    "Given I have a section with repeating answers for a supplementary list, " +
      "When I reach the section summary page, Then I see the supplementary data and my answers rendered correctly",
    async () => {
  ...
  it(
    "Given I am using a supplementary dataset where the size of one of the lists skips a question in a section, " +
      "When I enter the section, Then I only see an interstitial block as the other block is skipped",
    async () => {
  ...
  it(
    "Given the survey has been relaunched with new data and more items in the products list, " +
      "When I am on the Hub, Then I see the products section and section with a new block due to the product list size are both in progress",
    async () => {
    await browser.openQuestionnaire("test_supplementary_data_repeating_block_and_calculated_summary.json", {
      version: "v2",
  ...
  it(
    "Given I am using a supplementary dataset with a product list size that skips a question in the sales target section, " +
      "When I enter the section, Then I only see an interstitial block",
    async () => {
  ...
  it(
    "Given there is now an additional product, " +
      "When I resume the Product Details Section, Then I start from the list collector content block and see the new product is incomplete",
    async () => {
  ...
  it(
    "Given I complete the section and relaunch with the old data that has fewer items in the products list, " +
      "When I am on the Hub, Then I see the products section and sales targets sections are now in progress",
    async () => {
