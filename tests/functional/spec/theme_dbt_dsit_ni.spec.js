...
describe("Theme DBT-DSIT-NI", () => {
  describe("Given I launch a DBT-DSIT-NI themed questionnaire", () => {
    ...
    it("When I navigate to the radio page, Then I should see DBT-DSIT-NI theme content", async () => {
      ...
      await expect(normalizeHtml(await $("#dbt-logo-alt").getHTML())).toContain("Department for Business and Trade logo");
      await expect(normalizeHtml(await $("#dsit-logo-alt").getHTML())).toContain("Department for Science, Innovation and Technology logo");
