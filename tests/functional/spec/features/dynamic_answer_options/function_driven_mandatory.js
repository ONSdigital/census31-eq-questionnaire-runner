...
import DynamicMutuallyExclusivePage from
  "../../../generated_pages/dynamic_answer_options_function_driven_with_static_options_mandatory/dynamic-mutually-exclusive.page";
...
describe(`Feature: Dynamically generated mandatory answer options driven by a function with static options`, () => {
  describe("Given a mandatory dynamic answer options questionnaire with static options", () => {
    ...
    it(
      "When I do not answer the Mutually Exclusive Checkbox question and submit, " +
        "then an error message and the question error panel should be displayed.",
      async () => {
