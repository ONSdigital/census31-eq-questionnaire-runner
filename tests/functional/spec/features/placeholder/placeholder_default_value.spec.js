...
describe("Placeholder default value check", () => {
  ...
  it(
    "Given a question with default answer, When I do not enter any number and click submit, " +
      "Then the interstitial page shows default employees number as 0",
    async () => {
  ...
  it(
    "Given a question with default answer, When I enter a number of employee and click submit, " +
      "Then the interstitial page shows me the employees number entered",
    async () => {
  ...
  it(
    "Given a training budget question with default answer, " +
      "When I do not enter any amount and click submit, Then the interstitial page shows default amount as 250.00",
    async () => {
    await click(EmployeesNumberBlockPage.submit());
  ...
  it(
    "Given a training budget question with default answer, " +
      "When I enter an amount and click submit, Then the interstitial page shows amount entered",
    async () => {
    await click(EmployeesNumberBlockPage.submit());
    await click(EmployeesNumberInterstitialPage.submit());
