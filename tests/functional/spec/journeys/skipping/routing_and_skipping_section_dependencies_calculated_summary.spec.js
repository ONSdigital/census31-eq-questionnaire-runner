import CalculatedSummarySectionSummaryPage from
  "../../../generated_pages/routing_and_skipping_section_dependencies_calculated_summary/calculated-summary-section-summary.page";
...
import DependentQuestionSectionSummaryPage from
  "../../../generated_pages/routing_and_skipping_section_dependencies_calculated_summary/dependent-question-section-summary.page";
...
describe("Routing and skipping section dependencies based on calculated summaries", () => {
  describe("Given the section dependencies based on a calculated summary questionnaire", () => {
    ...
    it(
      "When a question in another section has a skip condition dependency on a calculated summary total, " +
        "and the skip condition is not met (total less than £10), then the dependent question should be displayed",
      async () => {
      await $(HubPage.summaryRowLink("calculated-summary-section")).click();
    ...
    it(
      "When a question in another section has a skip condition dependency on a calculated summary total, " +
        "and the skip condition is met (total greater than £10), then the dependent question should not be displayed",
      async () => {
      await $(HubPage.summaryRowLink("calculated-summary-section")).click();
    ...
    it(
      "When a question in another section has a routing rule dependency on a calculated summary total, " +
        "and the calculated summary total is greater than £100, then we should be routed to the second question block",
      async () => {
      await $(HubPage.summaryRowLink("calculated-summary-section")).click();
    ...
    it(
      "When a question in another section has a routing rule dependency on a calculated summary total, " +
        "and the calculated summary total is less than £100, then we should be routed to the section summary",
      async () => {
      await $(HubPage.summaryRowLink("calculated-summary-section")).click();
    ...
    it(
      "When a question in another section has a dependency on a calculated summary total, and both sections are complete, " +
        "and I go back and edit the calculated summary total, then the dependent section status should be in progress",
      async () => {
      await $(HubPage.summaryRowLink("calculated-summary-section")).click();
      await $(FirstQuestionBlockPage.milk()).setValue(20);
      await $(FirstQuestionBlockPage.eggs()).setValue(20);
    ...
    it(
      "When the calculated summary total is less than £100 but additional answers on the path are opened up " +
        "as a result of editing an answer, Then the dependent section should be enabled",
      async () => {
      await $(HubPage.summaryRowLink("calculated-summary-section")).click();
    ...
    it(
      "When the calculated summary total is equal to £100 but answers on the path are remove " +
        "as a result of an answer edit, Then the dependent section should be enabled",
      async () => {
      await $(HubPage.summaryRowLink("calculated-summary-section")).click();
      await $(FirstQuestionBlockPage.milk()).setValue(10);
      await $(FirstQuestionBlockPage.eggs()).setValue(10);
