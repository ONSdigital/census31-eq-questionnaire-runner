...
error_messages = {
    ...
    "MANDATORY_RADIO": lazy_gettext('Select an answer <span class="ons-u-vh">to ‘%(question_title)s’</span>'),
    ...
    "INVALID_YEAR_FORMAT": lazy_gettext("Enter the year in a valid format. For example, 2023."),
}
