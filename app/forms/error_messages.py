...
error_messages = {
    ...
    "MANDATORY_RADIO": lazy_gettext('Select an answer <span class="u-vh">to ‘%(question_title)s’</span>'),
    "MANDATORY_DROPDOWN": lazy_gettext("Select an answer"),
    "MANDATORY_CHECKBOX": lazy_gettext('Select at least one answer <span class="u-vh">to ‘%(question_title)s’</span>'),
    ...
    "TOTAL_SUM_NOT_LESS_THAN_OR_EQUALS": lazy_gettext("Enter answers that add up to or are less than %(total)s"),
    "TOTAL_SUM_NOT_LESS_THAN": lazy_gettext("Enter answers that add up to less than %(total)s"),
    "TOTAL_SUM_NOT_GREATER_THAN": lazy_gettext("Enter answers that add up to greater than %(total)s"),
    "TOTAL_SUM_NOT_GREATER_THAN_OR_EQUALS": lazy_gettext("Enter answers that add up to or are greater than %(total)s"),
    "INVALID_EMAIL_FORMAT": lazy_gettext("Enter an email address in a valid format, for example name@example.com"),
    ...
    "MAX_LENGTH_EXCEEDED": lazy_gettext("You have entered too many characters. Enter up to %(max)d characters"),
    "INVALID_DATE": lazy_gettext("Enter a valid date"),
    "INVALID_DATE_RANGE": lazy_gettext("Enter a 'period to' date later than the 'period from' date"),
    "INVALID_DURATION": lazy_gettext("Enter a valid duration"),
    "INVALID_MOBILE_NUMBER": lazy_gettext("Enter a UK mobile number in a valid format, for example, 07700 900345 or +44 7700 900345"),
    "DATE_PERIOD_TOO_SMALL": lazy_gettext("Enter a reporting period greater than or equal to %(min)s"),
    "DATE_PERIOD_TOO_LARGE": lazy_gettext("Enter a reporting period less than or equal to %(max)s"),
