...
class ListContext(Context):
    ...
    def _build_list_items_context(
        ...
        if for_list_item_ids:
            list_item_ids = [list_item_id for list_item_id in list_item_ids if list_item_id in for_list_item_ids]
        ...
        for list_item_id in list_item_ids:
            ...
            if edit_block_id:
                if is_primary and primary_person_edit_block_id:
                    list_item_context["edit_link"] = partial_url_for(block_id=primary_person_edit_block_id)
                else:
    ...
    def _get_item_title(self, summary_definition, list_item_id, is_primary):
        rendered_summary = self._placeholder_renderer.render(summary_definition, list_item_id)
