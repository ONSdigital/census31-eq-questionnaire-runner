        ...
        *,
        ...
        for list_item_id in list_item_ids:
            ...
            if edit_block_id:
                ...
                # return_to answer id is used to snap back to the appropriate
                # list item when editing from a summary page.
                # Unlike other repeating answers that use
                # answer_id-list_item_id, the edit block is linked to
                # item-label and anchored by list item id.
