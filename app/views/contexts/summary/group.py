    ...
    def _build_blocks_and_links(
        ...
        *,
        ...
        for block in group_schema["blocks"]:
            # the block type will only be ListRepeatingQuestion when in the context
            # of a calculated summary or grand calculated summary
            # any other summary like section-summary will use the parent list
            # collector instead and render items as part of the ListCollector check
            # further down
