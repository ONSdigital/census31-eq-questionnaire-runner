...
class PrimaryPersonQuestion(Question):
    ...
    def parent_location(self):
        ...
        return Location(section_id=self._current_location.section_id, block_id=parent_id)

    def _get_routing_path(self):
        return self.router.routing_path(section_id=self._current_location.section_id)

    def is_location_valid(self):
        primary_person_list_item_id = self._questionnaire_store.list_store[self.current_location.list_name].primary_person

        return self.current_location.list_item_id == primary_person_list_item_id and self.router.can_access_location(self.parent_location, self._routing_path)
    ...
    def handle_post(self):
        ...
        self.questionnaire_store_updater.update_same_name_items(self.parent_block["for_list"], same_name_answer_ids)
