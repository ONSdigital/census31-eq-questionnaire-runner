...
class ListAddQuestion(ListAction):
    ...
    def handle_post(self):
        list_item_id = self.questionnaire_store_updater.add_list_item(self.parent_block["for_list"])
    ...
    def _resolve_custom_page_title_vars(self) -> MutableMapping:
        ...
        list_length = len(self._questionnaire_store.list_store[self._current_location.list_name])
