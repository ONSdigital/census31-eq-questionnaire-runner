...
class QuestionnaireStoreUpdaterBase:
    ...
    def capture_dependencies_for_list_change(self, list_name: str) -> None:
        ...
        for section_key in self.started_section_keys(section_ids=section_ids):
            # Only add sections that are repeated sections for this list, or the
            # section in which this list is collected.
            # Prevents list item progresses being added as dependants as these
            # are captured by started_section_keys(section_ids=section_ids).
    ...
    def _capture_block_dependent(self, dependent: Dependent, list_item_ids: Sequence[str] | Sequence[None]) -> None:
        ...
        section should be passed in with the list items
