...
def get_session_timeout_in_seconds(schema: QuestionnaireSchema) -> int:
    ...
    timeout = schema_session_timeout if schema_session_timeout and schema_session_timeout < default_session_timeout else default_session_timeout

    return timeout


def create_session_store(eq_session_id: str, user_id: str, user_ik: str, session_data: str) -> None:
    pepper = current_app.eq["secret_store"].get_secret_by_name("EQ_SERVER_SIDE_STORAGE_ENCRYPTION_USER_PEPPER")
